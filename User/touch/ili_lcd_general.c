...
//    {
//        sprintf("data bus test pass!\r\n");
//    }
//    else
//    {
//        sprintf("data bus test error: %04X %04X\r\n",temp1,temp2);
//    }
}
...
void lcd_Initializtion(void)
{
    ...
    {
       // sprintf("Invalid LCD ID:%08X\r\n",deviceid);
       // sprintf("Please check you hardware and configure.\r\n");
        return;
    }
    else
    {
        // sprintf("LCD Device ID : %04X \r\n",deviceid);
    }
