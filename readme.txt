...
Ce fichier Readme contient des informations sur le projet de micro-contrôleur pour un chronomètre à deux boutons, un jaune et un rouge. Le chronomètre permet de démarrer, arrêter et réinitialiser le compteur.
